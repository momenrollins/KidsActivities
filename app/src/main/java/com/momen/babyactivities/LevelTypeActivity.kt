            ...
            reportsBtn.setOnClickListener {
                ...
                if (lvl==1){
                    ...
                    if (SHARDStorage.sharedPreferences.getInt("level1rabbit", 0) !=0){
                        result="النشاط رقم${1}: ${SHARDStorage.sharedPreferences.getInt("level1rabbit",0)} "
                    }else  result=" النشاط رقم${1}: لا توجد اخطاء "

                    sb.append("$result \n");

                    if (SHARDStorage.sharedPreferences.getInt("level0", 0) !=0){
                        result="النشاط رقم${2}: ${SHARDStorage.sharedPreferences.getInt("level0",0)} "
                    }else  result=" النشاط رقم${2}: لا توجد اخطاء "

                    sb.append("$result \n");

                    if (SHARDStorage.sharedPreferences.getInt("level46", 0) !=0){
                        result="النشاط رقم${3}: ${SHARDStorage.sharedPreferences.getInt("level46",0)} "
                    ...
                    if (SHARDStorage.sharedPreferences.getInt("level47", 0) !=0){
                        result="النشاط رقم${4}: ${SHARDStorage.sharedPreferences.getInt("level47",0)} "
                    ...
                    if (SHARDStorage.sharedPreferences.getInt("level53", 0) !=0){
                        result="النشاط رقم${10}: ${SHARDStorage.sharedPreferences.getInt("level53",0)} "
